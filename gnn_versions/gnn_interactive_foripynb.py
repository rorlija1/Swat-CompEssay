...
def main(MP_layers, edge_threshold, fname, p = 0.25):
    ...
    root_dir = f"graph_inputdata/MD{fname}"
    ...
    MP_layers = MP_layers # num. of message-passing layers
    ...
    def write_parameter_summary(output_dir, task, snapshot_path, resume_choice, model_choice, num_epochs, savedmodel_save,
        ...
        with open(summary_file, "w") as f:
            ...
            f.write(f"TASK: {task}\n")
            f.write("GNN version: gnn_interactive_dropout.py\n")
    ...
    edge_threshold = edge_threshold # two nodes form an edge if separation shorter than threshold
